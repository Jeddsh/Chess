...
public class ChessGUI
{
	...
	public static class ChessBoard extends JPanel
	{
		...
		public boolean tryMate(Square k)
		{
			...
			if(k.getChesspiece() instanceof King) {
				ChessPiece kg = k.getChesspiece();
				...
				if(kg.getLegalMoves(k.getX(), k.getY(), true).isEmpty()) {
					//Create a new ArrayList<Square> called allLegalMoves.
					ArrayList<Square> AllLegalMoves = new ArrayList<>();
					...
					for(Square[] s:ChessGUI.ChessBoard.getSquares()) {
						for(Square ss: s) {
							...
							if(ss.getChesspiece() != null) {
								if(ss.getChesspiece().getColor() == kg.getColor()) {
									AllLegalMoves.addAll(ss.getChesspiece().getLegalMoves(ss.getX(), ss.getY(), true));
								}
							}
						}
					}
					...
					ArrayList<Square> union = Square.union(blockingSquares,capturingSquares);
					ArrayList<Square> intersect = Square.intersection(union, AllLegalMoves);
